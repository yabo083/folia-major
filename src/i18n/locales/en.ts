...
export default {
  ...
  "commandPalette": {
    ...
    "commands": {
      ...
      "background-nomand": { "title": "Background: Nomand", "description": "Switch background to theme-colored image dithering" },
  ...
  "options": {
    ...
    "sonnetPerformanceWarningDescription": "Sonnet uses a high-density animated scene and may place heavy demands on your GPU and CPU. Enabling it may cause severe stuttering, especially on lower-end devices.",
    "sonnetPerformanceWarningDontShowAgain": "Do not show this warning again",
    "decorNone": "None",
    "decorSubtle": "Subtle",
    "decorFull": "Full",
    ...
    "nomandBackgroundSettingsDesc": "Dither the current cover or uploaded image with colors from the active light/dark theme.",
    ...
    "nomandBackgroundOverlayDesc": "Layer the active theme background color over the dithered image to improve lyric readability.",
  ...
  "export": {
    ...
    "remoteConfirmPrompt": "Remote requested video export. Start recording now?",
    "remoteStartAction": "Start Recording",
  ...
  "localMusic": {
    ...
    "searchFailed": "Lyric search failed. The online music service may be unavailable.",
    "searchFailedHint": "You can still try again or switch to another source above.",
    "noLyricsAvailable": "No lyrics available",
