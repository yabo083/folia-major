...
export default {
  ...
  "commandPalette": {
    ...
    "commands": {
      ...
      "visualizer-sonnet": { "title": "切换到可视化：商籁", "description": "切换到商籁日式文字 PV" },
      ...
      "background-nomand": { "title": "背景切换到漫游", "description": "切换到使用主题配色的像素画背景" },
  ...
  "options": {
    ...
    "sonnetPerformanceWarningDescription": "商籁使用高密度动态场景，会对 GPU 和 CPU 造成较高负载。开启后可能出现严重卡顿，尤其是在性能较低的设备上。",
  ...
  "export": {
    ...
    "remoteConfirmPrompt": "远程窗口请求了视频导出，请在主窗口确认开始录制。",
    "remoteStartAction": "开始录制",
    "remoteStartCancel": "取消",
  },
  "player": {
    "unknownArtist": "未知歌手",
    "unknownAlbum": "未知专辑",
  ...
  "localMusic": {
    ...
    "saving": "保存...",
    "matchFailed": "获取歌词失败",
    "searchFailed": "歌词搜索失败，在线音乐服务可能不可用。",
    "searchFailedHint": "请重试，或在上方切换其他来源。",
    "noLyricsAvailable": "无可用歌词",
